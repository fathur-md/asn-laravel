<x-layout>
  <section class="bg-linear-to-b relative overflow-hidden from-transparent to-emerald-50 pb-20 pt-32">
  ...
  <section class="bg-white py-16">
    <div class="mx-auto max-w-6xl px-4">
      <div class="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
        ...
        <p class="max-w-xl text-sm text-slate-600">Temukan campaign kesehatan, pendidikan, bencana, dan sosial yang bisa
          Anda dukung dengan percaya diri.</p>
      </div>
      <div class="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        @foreach ($categories as $category)
          <span
            class="rounded-3xl border border-emerald-100 bg-emerald-50 px-4 py-3 text-sm font-semibold text-emerald-700">{{ $category }}</span>
        @endforeach
      </div>
    </div>
  </section>
